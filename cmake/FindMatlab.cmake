...
function(matlab_add_mex)
  ...
  if(NOT Matlab_VERSION_STRING VERSION_LESS "9.1") # For 9.1 (R2016b) and newer, add version source file
    ...
    elseif("CXX" IN_LIST _enabled_languages)
      ...
      # If neither C or CXX is enabled, raise a fatal error
      # TODO: add support for fortran mex files
      message(FATAL_ERROR "[MATLAB] matlab_add_mex requires that at least C or CXX are enabled languages")
    endif()
  ...
  if(${prefix}_EXECUTABLE)
    ...
    message(STATUS "MEX_VERSION_FILE is ${MEX_VERSION_FILE}")
  ...
  if(WIN32)
    ...
    if (MSVC)
      ...
      message(STATUS "Setting link flags of target ${${prefix}_NAME} with name ${${prefix}_OUTPUT_NAME}") 
